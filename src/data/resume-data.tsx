...
export const RESUME_DATA = {
  ...
  work: [
    {
      ...
      description:
        "Lead research and report creation for new prospects and current portfolio startups on a variety of tech industries. Working remotely for C Level partners in topics like AI, Web3, and Data.",
    },
    {
  ...
  projects: [
    ...
    },
    {
      ...
      description:
        "Resi-token is an ERC-20 token designed to incentivize community participation within the Speezard accelerator. Its primary purpose is to reward builders and contributors who support early-stage blockchain projects in validating product–market fit.",
      logo: MonitoLogo,
      link: {
        label: "Github",
    ...
    },
    {
      ...
      description:
        "Growth and validation of the first web3 Accelerator in LATAM",
      logo: Minimal,
      link: {
        label: "speezard.io",
